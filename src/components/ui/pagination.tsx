...
const paginationVariants = tv({
  slots: {
    ...
    item: "text-label-sm text-text-sub-600 flex items-center justify-center text-center transition duration-200 ease-out",
    navButton:
      "text-text-sub-600 flex items-center justify-center transition duration-200 ease-out",
    navIcon: "size-5",
  },
  variants: {
    variant: {
      basic: {
        ...
        item: [
          // base
          "ring-stroke-soft-200 h-8 min-w-8 rounded-lg px-1.5 ring-1 ring-inset",
          // hover
      ...
      rounded: {
        ...
        item: [
          // base
          "ring-stroke-soft-200 h-8 min-w-8 rounded-full px-1.5 ring-1 ring-inset",
          // hover
          "hover:bg-bg-weak-50 hover:ring-transparent",
        ],
        navButton: [
      ...
      group: {
        root: "divide-stroke-soft-200 border-stroke-soft-200 divide-x overflow-hidden rounded-lg border",
        item: [
          // base
          "h-8 min-w-10 px-1.5",
          // hover
