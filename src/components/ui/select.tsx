...
export const selectVariants = tv({
  slots: {
    triggerRoot: [
      // base
      "group/trigger bg-bg-white-0 shadow-regular-xs ring-stroke-soft-200 min-w-0 shrink-0 ring-1 outline-hidden ring-inset",
      ...
      // focus
      "focus:shadow-button-important-focus focus:ring-stroke-strong-950 focus:outline-hidden",
    ...
    triggerArrow: [
      ...
      "text-text-sub-600",
      // hover
      "group-hover/trigger:text-text-sub-600 group-hover:group-data-placeholder/trigger:text-text-sub-600",
      // focus
      "group-focus/trigger:text-text-strong-950 group-focus/trigger:group-data-placeholder/trigger:text-text-strong-950",
      // disabled
      "group-disabled/trigger:text-text-disabled-300 group-disabled/trigger:group-data-placeholder/trigger:text-text-disabled-300",
      // open
    ...
    triggerIcon: [
      ...
      // disabled
      "group-disabled/trigger:text-text-disabled-300 group-disabled/trigger:group-data-placeholder/trigger:text-text-disabled-300",
      "[&:not(.remixicon)]:group-disabled/trigger:opacity-[.48]",
    ],
    selectItemIcon: [
  ...
  compoundVariants: [
    //#region default
    {
      ...
      variant: "default",
      class: {
        triggerRoot: "rounded-10 h-10 min-h-10 gap-2 pr-2.5 pl-3",
      },
    },
    {
      size: "small",
      variant: "default",
      class: {
        triggerRoot: "h-9 min-h-9 gap-2 rounded-lg pr-2 pl-2.5",
        triggerArrow: "size-4",
      },
    },
    {
    ...
    //#region compact
    {
      ...
      variant: "compact",
      class: {
        triggerRoot: "rounded-10 h-10 gap-1 pr-2.5 pl-3",
        triggerIcon: "-ml-0.5",
    ...
    },
    {
      ...
      variant: "compact",
      class: {
        triggerRoot: "h-9 gap-1 rounded-lg pr-2 pl-3",
        triggerIcon: "-ml-0.5",
        selectItemIcon: "group-has-[&]/trigger:-ml-0.5",
        triggerArrow: "size-4",
      },
    },
    {
      ...
      variant: "compact",
      class: {
        triggerRoot: "h-8 gap-0.5 rounded-lg pr-1.5 pl-2.5",
  ...
  return (
    ...
    >
      ...
      <SelectPrimitives.Icon asChild>
        <RiExpandUpDownLine className={triggerArrow()} />
      ...
      >
        <ScrollAreaPrimitives.Root type="auto">
          ...
          <ScrollAreaPrimitives.Scrollbar orientation="vertical">
            <ScrollAreaPrimitives.Thumb className="bg-bg-soft-200 w-1! rounded-sm" />
