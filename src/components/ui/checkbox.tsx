      ...
      >
        <rect
          ...
          className={cn(
            ...
            // disabled checked
            "group-data-[state=checked]/checkbox:group-disabled/checkbox:fill-bg-soft-200",
            "group-data-[state=indeterminate]/checkbox:group-disabled/checkbox:fill-bg-soft-200",
          )}
        />
        <g
        // filter={`url(#${filterId})`}
