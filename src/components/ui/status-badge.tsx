...
export const statusBadgeVariants = tv({
  slots: {
    root: [
      "text-label-xs inline-flex h-6 items-center justify-center gap-2 rounded-md px-2 whitespace-nowrap",
      "has-[>.dot]:gap-1.5",
    ],
    icon: "-mx-1 size-4",
    dot: [
  ...
  variants: {
    variant: {
      stroke: {
        root: "bg-bg-white-0 text-text-sub-600 ring-stroke-soft-200 ring-1 ring-inset",
      },
      light: {},
    },
    status: {
