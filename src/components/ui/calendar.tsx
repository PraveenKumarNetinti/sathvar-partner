  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day: cn(
          // base
          "text-label-sm text-text-sub-600 flex size-10 shrink-0 items-center justify-center rounded-lg text-center outline-hidden",
          ...
          // focus visible
          "focus-visible:bg-bg-weak-50 focus-visible:text-text-strong-950 focus:outline-hidden",
        ),
