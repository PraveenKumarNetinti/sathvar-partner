...
>(({ className, children, ...rest }, forwardedRef) => {
  return (
    <SelectPrimitives.Trigger
      ...
      className={cn(
        // base
        "group/trigger bg-bg-white-0 min-w-0 shrink-0 px-3 outline-none",
        "text-paragraph-sm text-text-strong-950",
        "rounded-10 flex h-10 items-center text-left ring-1 ring-transparent ring-inset",
        "transition duration-200 ease-out",
        // hover
        "hover:bg-bg-weak-50",
        // focus
        "focus:text-text-strong-950 focus:ring-primary-base focus:outline-none",
        // open
