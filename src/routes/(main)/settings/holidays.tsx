...
export const Route = createFileRoute("/(main)/settings/holidays")({
...
function RouteComponent() {
  ...
  const columns: ColumnDef<HolidaysData>[] = [
    {
      id: "select",
      header: ({ table }) => (
        <Checkbox.Root
    ...
    },
    {
      ...
      header: ({ column }) => (
        <div className="flex items-center gap-0.5">
          <span className="text-paragraph-sm text-text-sub-600">S.No</span>
          <button
            type="button"
    ...
    },
    {
      ...
      header: ({ column }) => (
        <div className="flex items-center gap-0.5">
          <span className="text-paragraph-sm text-text-sub-600">Occasion</span>
          <button
            type="button"
            onClick={() => column.toggleSorting(column.getIsSorted() === "asc")}
          >
      ...
      <Header
        icon={
          <div className="flex size-12 shrink-0 items-center justify-center rounded-full bg-bg-white-0 shadow-regular-xs ring-1 ring-inset ring-stroke-soft-200">
            <RiCalendar2Line className="size-6 text-text-sub-600" />
          </div>
        }
        title="Holidays"
        description="Manage official holidays and breaks."
      >
          ...
          <div className="ml-auto flex w-full flex-col gap-3 sm:w-auto sm:flex-row">
            <Input.Root size="small" className="w-full sm:w-auto">
              <Input.Wrapper>
                ...
                <Input.Input placeholder="Search Holiday" />
                <Kbd.Root>⌘1</Kbd.Root>
              </Input.Wrapper>
            </Input.Root>
